    ...
    try {
      if (myLocation) {
        ...
        const res = await axiosInstance.get(
          `/community-resources/nearby?${params}`,
        );
      ...
      <section className="dashboard-shell user-dashboard-shell">
        <header className="dashboard-topnav user-topnav">
          <div className="dashboard-topnav-left">
            ...
            <div className="dashboard-title-block">
              ...
              <p>
                Find AEDs, fire extinguishers &amp; emergency services nearby
              </p>
            </div>
          </div>
          <div className="dashboard-topnav-right">
            <button
              type="button"
              className="dashboard-btn sr-add-btn"
              onClick={() => setShowForm(!showForm)}
            >
              <Plus size={14} />{" "}
              <strong>{showForm ? "Cancel" : "Add Resource"}</strong>
            </button>
            <button
              type="button"
        ...
        <section className="dashboard-stats-row user-stats-row">
          <article className="stat-card stat-card--incidents">
            ...
            <p className="stat-meta">
              <strong>Mapped</strong> community resources
            </p>
          </article>
          <article className="stat-card stat-card--responders">
            ...
            <p className="stat-meta">
              <strong>Verified</strong> by community
            </p>
          </article>
          <article className="stat-card stat-card--eta">
            ...
            <p className="stat-meta">
              <strong>Different</strong> categories
            </p>
          </article>
        </section>
        ...
        <section className="dashboard-main-grid user-dashboard-grid">
            ...
            {showForm ? (
              <>
                ...
                <p className="panel-caption">
                  <strong>Pin</strong> a community resource at your location
                </p>
                <form className="ri-form cr-form" onSubmit={handleSubmit}>
                  <div className="ri-field">
                    ...
                    <input
                      className="ri-input"
                      placeholder="e.g., Mall AED Station"
                      value={formName}
              ...
              <>
                ...
                <p className="panel-caption">
                  <strong>Nearby</strong> community resources
                </p>
                  ...
                  {resources.length === 0 ? (
                    <div className="update-item ud-empty-state">
                      ...
                      <p className="update-text">
                        Add community resources to help your neighborhood!
                      </p>
                    </div>
                  ) : (
                    resources.map((r) => {
                      ...
                      return (
                        <div
                          className="update-item cr-resource-card"
                          key={r._id}
                        >
                          <div className="ud-incident-header">
                            <span
                              className="ud-incident-badge"
                          ...
                          {r.description && (
                            <p className="update-text">{r.description}</p>
                          )}
                          {r.address && (
                            <p className="update-text cr-address">
                              <MapPin size={11} /> {r.address}
                            </p>
                          )}
                          {r.contactPhone && (
                            <p className="update-text cr-phone">
                              <Phone size={11} /> {r.contactPhone}
                            </p>
                          )}
                          <p className="update-text cr-hours">
                            Hours: {r.operatingHours || "24/7"}
                          </p>
                          <button
                            type="button"
          ...
          <section className="dashboard-panel live-map-panel user-panel glass-card">
            ...
            <p className="panel-caption">
              <strong>Community</strong> resources near you
            </p>
            <div className="map-box">
              {myLocation ? (
                  ...
                  {resources.map((r) => {
                    ...
                    return (
                      <Marker
                        key={r._id}
                        position={[lat, lng]}
                        icon={icons[r.type] || icons.default}
                      >
                        <Popup>
                          <div style={{ minWidth: 160 }}>
                            ...
                            {r.address && (
                              <p style={{ fontSize: 12 }}>{r.address}</p>
                            )}
                            {r.contactPhone && (
                              <p style={{ fontSize: 12 }}>{r.contactPhone}</p>
                            )}
                            {r.distanceKm !== undefined && (
                              <p
                                style={{
                ...
                <div
                  style={{ height: 400, display: "grid", placeItems: "center" }}
                >
                  Loading location...
                </div>
              )}
          ...
          <aside className="dashboard-panel user-panel glass-card ud-updates-panel">
            ...
            <p className="panel-caption">
              <strong>Hospitals, Fire &amp; Police</strong> nearby
            </p>
            <div className="update-list">
              {resources.filter((r) =>
                ...
                <div className="update-item ud-empty-state">
                  ...
                  <p className="update-title">
                    <strong>No emergency services mapped</strong>
                  </p>
                  <p className="update-text">
                    Add nearby hospitals, fire stations, and police stations to
                    help the community.
                  </p>
                </div>
              ) : (
