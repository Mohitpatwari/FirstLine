  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (!suggestedList.length) {
        try {
          const suggestResponse = await axiosInstance.get(
            `/incidents/${incident?._id}/best-volunteer`,
          );
  ...
  const handleSendSmsToSelected = async () => {
    ...
    try {
      const response = await axiosInstance.post(
        `/incidents/${submittedIncidentId}/notify-suggested`,
        {
          selectedVolunteerId,
        },
      );
      ...
      setStatus({
        ...
        message:
          ...
          "Failed to send SMS to selected volunteer.",
      });
    } finally {
      setSendingSms(false);
    }
        ...
        <section className="dashboard-stats-row user-stats-row ri-stats-row">
          <article className="stat-card stat-card--incidents">
            ...
            <p className="stat-meta">
              <strong>Selected</strong> category
            </p>
          </article>
          <article className="stat-card stat-card--responders">
            <div className="stat-head">
              <p className="stat-label">
                <strong>Broadcast Radius</strong>
              </p>
            ...
            <p className="stat-meta">
              <strong>Alert</strong> coverage area
            </p>
          </article>
          <article className="stat-card stat-card--eta">
            <div className="stat-head">
              <p className="stat-label">
                <strong>Volunteers Suggested</strong>
              </p>
            ...
            <p className="stat-meta">
              <strong>AI-matched</strong> responders
            </p>
          </article>
        </section>
        ...
        <section className="dashboard-main-grid user-dashboard-grid ri-grid">
          ...
          <div className="dashboard-panel user-panel glass-card ri-form-panel">
            ...
            <p className="panel-caption">
              <strong>Fill in</strong> the information below
            </p>
            ...
            <form className="ri-form" onSubmit={handleSubmit}>
              ...
              {status.message ? (
                <div
                  className={`ri-status-banner ${status.type === "success" ? "ri-status--success" : "ri-status--error"}`}
                >
                  {status.type === "success" ? (
          ...
          <div className="dashboard-panel live-map-panel user-panel glass-card ri-center-panel">
            <h3>
              <strong>AI Guidance &amp; Volunteers</strong>
            </h3>
            <p className="panel-caption">
              <strong>Smart assistance</strong> for your incident
            </p>
            ...
            {guidance?.firstResponseSteps?.length ? (
              <div className="ri-guidance-box">
                <p className="ri-guidance-title">
                  ...
                  <strong>First-Response Guidance</strong>
                </p>
              ...
              <div className="ri-empty-guidance">
                ...
                <p>
                  <strong>Select an incident type</strong> and describe it to
                  get AI guidance
                </p>
              </div>
            )}
            ...
            {guidance?.emergencySummary ? (
              <div className="ri-summary-box">
                <p className="ri-guidance-title">
                  <FileText size={14} />{" "}
                  <strong>Emergency Summary (read to services)</strong>
                </p>
                <div className="ri-summary-text">
                  {guidance.emergencySummary}
                </div>
              </div>
            ) : null}
            ...
            {suggestedVolunteers.length > 0 ? (
              <div className="ri-volunteers-box">
                    ...
                    >
                      ...
                      <div className="ri-volunteer-info">
                        ...
                        <span className="ri-volunteer-meta">
                          Rating{" "}
                          <strong>{volunteer.volunteerRating}/100</strong>{" "}
                          &bull; Trust{" "}
                          <strong>{volunteer.trustScore}/10</strong> &bull;{" "}
                          <strong>{volunteer.distanceKm} km</strong> away
                        </span>
                        {volunteer.skills?.length > 0 && (
                          <span
                            className="ri-volunteer-meta"
                            style={{ fontSize: 12 }}
                          >
                            <Award size={11} /> Skills:{" "}
                            <strong>{volunteer.skills.join(", ")}</strong>
                          </span>
                        )}
                        ...
                        {volunteer.recommendationScore != null && (
                          ...
                          >
                            AI Score:{" "}
                            <strong>
                              {(volunteer.recommendationScore * 100).toFixed(0)}
                              %
                            </strong>
                          </span>
                        )}
                ...
                <div className="ri-volunteer-actions">
                  ...
                  >
                    <Send size={14} />
                    <strong>
                      {sendingSms ? "Sending SMS..." : "Send SMS to Volunteer"}
                    </strong>
                  </button>
                  <button
                    type="button"
              ...
              <div className="ri-empty-guidance" style={{ marginTop: 12 }}>
                ...
                <p>
                  <strong>No matching volunteers found nearby.</strong>
                </p>
                <p style={{ fontSize: 12, color: "#888" }}>
                  Try a larger broadcast radius or wait for volunteers to come
                  online.
                </p>
              </div>
            ) : null}
              ...
              <div className="ud-skilled-box">
                ...
                {skilledResponders.map((sr) => (
                  <div className="ud-skilled-item" key={sr._id}>
                    ...
                    <span className="sr-responder-distance">
                      {sr.distanceKm} km
                    </span>
                  </div>
                ))}
            ...
            {nearbyEmergencyServices.length > 0 && (
              <div className="ud-emergency-box">
                <p className="ud-emergency-title">
                  <Building2 size={14} />{" "}
                  <strong>Nearby Emergency Services</strong>
                </p>
          ...
          <aside className="dashboard-panel user-panel glass-card ri-info-panel">
            ...
            <div className="ri-info-list">
              <div className="ri-info-step">
                <span className="ri-step-number">
                  <strong>1</strong>
                </span>
                <div>
                  <p className="ri-step-title">
              ...
              <div className="ri-info-step">
                ...
                <div>
                  ...
                  <p className="ri-step-desc">
                    Alert gets broadcast to nearby volunteers
                  </p>
                </div>
              </div>
              <div className="ri-info-step">
                ...
                <div>
                  ...
                  <p className="ri-step-desc">
                    Send SMS to the best-matched volunteer
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="ri-tips-list">
              <p>
                <strong>Be specific</strong> in your description for better AI
                matching
              </p>
              <p>
                <strong>Enable location</strong> access for accurate
                broadcasting
              </p>
              <p>
                <strong>Larger radius</strong> reaches more volunteers but may
                delay response
              </p>
            </div>
          </aside>
      ...
      {showSuggestionPopup && suggestedVolunteers.length ? (
        <div className="sos-option-overlay" role="dialog" aria-modal="true">
          <div className="sos-option-popup ud-sos-popup ri-popup">
            ...
            <h3>
              <strong>Top Rated Volunteers (AI)</strong>
            </h3>
              ...
              {suggestedVolunteers.map((volunteer, idx) => (
                ...
                >
                  ...
                  <div className="ri-volunteer-info">
                    ...
                    <span className="ri-volunteer-meta">
                      Rating <strong>{volunteer.volunteerRating}/100</strong>{" "}
                      &bull; Trust <strong>{volunteer.trustScore}/10</strong>{" "}
                      &bull; <strong>{volunteer.distanceKm} km</strong>
                    </span>
                    {volunteer.skills?.length > 0 && (
                      <span
                        className="ri-volunteer-meta"
                    ...
                    {volunteer.matchedSkills?.length > 0 && (
                      ...
                      >
                        Matched:{" "}
                        <strong>{volunteer.matchedSkills.join(", ")}</strong>
                      </span>
                    )}
                  </div>
                </label>
